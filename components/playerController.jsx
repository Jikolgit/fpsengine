...
objArg.walkEffectTimer.value++;
if(objArg.walkEffectTimer.value == 10)
{
  objArg.walkEffectTimer.value = 0
  objArg.camRef.current.position.y = Math.round(objArg.camRef.current.position.y * 1000)/1000
  if(objArg.camRef.current.position.y == 0.8){objArg.camRef.current.position.y = 0.805}
  else if(objArg.camRef.current.position.y == 0.805){objArg.camRef.current.position.y = 0.8}
